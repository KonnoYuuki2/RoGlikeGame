    ...
    if (monster.def === true) {
      ...
      if (conPro === 0) {
        ...
        for (let i = 0; i < conPro; i++) {
          ...
          console.log(
            chalk.yellow(
              `플레이어가 몬스터에게 연속 공격을 사용하여 ${damage}의 데미지를 입혔습니다.`,
            ),
          );
          monster.hp -= damage;
        }
...
class Monster {
  ...
  superAttack(player) {
    ...
    if (player.def) {
      ...
      console.log(
        chalk.red(`몬스터가 플레이어에게 강타를 사용하여 ${damage}의 데미지를 입혔습니다.`),
      );
      player.hp -= damage;
    }
  }
...
class Dragon extends Monster {
  ...
  superAttack(player) {
    ...
    if (player.def) {
      ...
      console.log(
        chalk.red(`드래곤이 플레이어에게 불기둥을 사용하여 ${damage}의 데미지를 입혔습니다.`),
      );
      player.hp -= damage;
    }
  }
...
class Oak extends Monster {
  ...
  superAttack(player) {
    ...
    if (player.def) {
      ...
      console.log(
        chalk.red(`오크가 플레이어에게 몽둥이찜질 사용하여 ${damage}의 데미지를 입히고
